$(document).ready(function() {
  ...
  appId: "1:789533339991:web:ac16344d48d2764927ce12"
    ...
    $("#tablatrenzas").on("click", ".btnEditar", function() {    
        ...
        let municipio = $(this).closest('tr').find('td:eq(3)').text();
        let estado = $(this).closest('tr').find('td:eq(4)').text();
        let cantidad= $(this).closest('tr').find('td:eq(5)').text(); 
        let fecha_ent = $(this).closest('tr').find('td:eq(6)').text();
        let enviado = $(this).closest('tr').find('td:eq(7)').text();
        let guia = $(this).closest('tr').find('td:eq(8)').text();
        let periodo = $(this).closest('tr').find('td:eq(9)').text();                
        $('#id').val(id);        
        $('#enlace').val(enlace);
        $('#region').val("4");                
