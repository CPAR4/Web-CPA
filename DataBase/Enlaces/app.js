  ...
  appId: "1:789533339991:web:ac16344d48d2764927ce12"
    ...
    var table = $('#tablaenlaces').DataTable({
                ...
                columnDefs: [
                    ...
                    {
                        targets: -1,        
                        defaultContent: "<div class='wrapper text-center'><div class='btn-group'><button class='btnEditar btn btn-primary' data-toggle='tooltip' title='Editar'>"+iconoEditar // + "</button><button class='btn btn-success' data-toggle='tooltip' title='editar'>"+inconoDownload+"</button>"
                    }
                ]	   
            });
